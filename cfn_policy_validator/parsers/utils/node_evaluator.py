...
class NodeEvaluator:
    def __init__(self, template, account_config, get_latest_ssm_parameter_version, parameter_values):
        ...
        self.dynamic_reference_evaluator = DynamicReferenceEvaluator(account_config.region, get_latest_ssm_parameter_version)
